...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <img src="{{ config('app.url') }}/public/dashboard/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                <img src="{{ config('app.url') }}/public/dashboard/dist/img/noimage.jpg" class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info">
